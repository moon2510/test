	...
	<div class="row">
		...
		<div class="col-5">
			<div class="book-cover">
				@if($book->img == null)
				<img src="{{ asset('images/default.jpg') }}" height="300px">
				@else
							...
							<div class="average-evalate">
								<div style="text-align: center;">
									...
									<div>
										...
										@for($i = 0; $i < (int)$average_evalate;$i++) <i class="fas fa-star" style="color: #f1c40f;"></i>
											@endfor
											@if(($average_evalate + (int)$remain) != 5)
											<i class="fas fa-star-half-alt" style="color: #f1c40f;"></i>
											@endif

											@for($i = 0; $i < (int)$remain;$i++) <i class="far fa-star" style="color: #f1c40f"></i>
												@endfor
									</div>
									<br>
						...
						<div class="col-md-8">
							<div class="evalate-on-percent">
								<div style="width: 100%">
									...
									@endphp
									@for($i = 1; $i <= 5;$i++) <div class="percent-container">
										<div class="row">
			...
			<div class="col-9">
				<div class="rating-section">
					<table class="table">
						...
						<tbody>
							<tr>
								@for($i = 1;$i <= 5;$i++) @if($user_rating && $user_rating->star_number == $i)
									<td>
			...
			<div class="col-11 comment">
				...
				<div style="width: 100%;font-weight: bold" class="mt-2">
					...
					@for($i = 1; $i <= $rating->star_number; $i++)
						...
						@for($i = 1; $i <= $remaining_rating; $i++) <i class="fas fa-star" style="color: darkgray"></i>
							@endfor

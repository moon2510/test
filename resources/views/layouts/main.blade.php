		...
		<div class="row justify-content-center">
			<div class="col-11 col-xl-9">
				<div class="d-sm-flex justify-content-between">
					<ul>
						<li><a href="tel:+01432152323"><span class="align-middle"><i class="fas fa-mobile-alt"></i></span>+84915012166</a></li>
						<li><a href="mailto:info@example.com"><span class="align-middle"><i class="fas fa-envelope-open-text"></i></span>nguyetminhthibui@gmail.com</a></li>
					</ul>
					<ul>
			...
			<div class="col-11 col-xl-10">
				<div class="row">
					...
					<div class="d-none d-md-block col-md-2 col-xl-3 cartt">
						...
						@endif -->
						<a><i class="fas fa-shopping-cart carticon"></i>Cart <p class="cartnumber"></p></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-11 col-md-8">
					<div class="row">
						<div class="col-12 col-md-5 center">
							<p class="h3 text-white text-center">Have a nice day</p>
						</div>
			...
			<div class="col-11 col-md-8 mb-4">
				<div class="row justify-content-center">
					<div class="col-12 col-md-6 col-xl-3 mx-auto mb-4">
						<h6 class="text-uppercase font-weight-bold title">ATN Shop Toy</h6>
						<p>Welcome to the ATN Shop Toy</p>
					</div>
					...
					<div class="col-12 col-md-6 col-xl-3 mx-auto mb-4">
						...
						<p><i class="fas fa-home mr-3"></i> Viet Nam</p>
						<p><i class="fas fa-envelope mr-3"></i> nguyetminhthibui@gmail.com</p>
						<p><i class="fas fa-phone mr-3"></i> + 84915012166</p>

					</div>
				</div>
			</div>
		</div>
		<div class="footer-copyright text-center py-3">© 2021 Copyright: ATN Shop
			<!-- <a href="{{ route('home') }}"> atn-shop-toys.herokuapp.com</a> -->
		</div>
	</footer>
